...
@TeleOp(name = "RoverVuforia_V01_51 (Blocks to Java)", group = "")
public class RoverVuforia_V01_51 extends LinearOpMode {
  ...
  private void TargetTourWall() {
    ...
    zTourString = "";
    androidTextToSpeech.speak("Rotate  to wall");
    sleep(3000);
    telemetry.update();
    zTargLen = zTourLen;
    androidTextToSpeech.speak("Roll to wall");
    DriveToTarget();
    sleep(3000);
  }
